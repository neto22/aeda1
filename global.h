...
/**
* @brief Asks for a line with a "question" and returns a string with the answer
...
/**
* @brief Asks for a number with "question" and loops until gets a number between min and max
